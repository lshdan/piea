...
###########################################################################
cfg.all_filters = [
    GammaFilter, WNBFilter, ImprovedWhiteBalanceFilter,
    ExposureFilter, ToneFilter, SaturationPlusFilter, ContrastFilter, ColorFilter
]
cfg.importance = [
    1., 1., 1., 1., 1., 1., 1., 1.
]
...
# dxy: this indicates whether all the filters share the basic CNN structure.
...
# cfg.num_state_dim = 3 + len(cfg.all_filters)
# cfg.z_dim = 3 + len(cfg.all_filters) * cfg.z_dim_per_filter
cfg.test_steps = 5
